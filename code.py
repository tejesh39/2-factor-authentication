...
def goToPage1():
    ...
    page1 = LabelFrame(mainFrame, bg='Grey')
    page1.grid(columnspan=5, ipady=60, padx=10, pady=10)

    globalPageKey = page1

    atmId = Label(page1, text="ATM ID", bg='Grey')
...
# Page 0
page0 = LabelFrame(mainFrame, bg='Black')
...
# Welcome text
welcomeText = Label(page0, text='Welcome to our Security System', font=('Courier', 20), bg='Yellow')
...
buttonsFrame = LabelFrame(bottomFrame, bg='Dark Grey')
...
img10 = ImageTk.PhotoImage(Image.open("0.jpg"))


# Fixed buttons
button1 = Button(buttonsFrame, image=img1, fg='Black', bg='Green', command=lambda: pressButton(globalList[0]), height=40, width=40)
button1.grid(row=1, column=0, padx=5, pady=5)

button2 = Button(buttonsFrame, image=img2, fg='Black', bg='Purple', command=lambda: pressButton(globalList[1]), height=40, width=40)
button2.grid(row=1, column=1, padx=5, pady=5)

button3 = Button(buttonsFrame, image=img3, fg='Black', bg='Pink', command=lambda: pressButton(globalList[2]), height=40, width=40)
button3.grid(row=1, column=2, padx=5, pady=5)

button4 = Button(buttonsFrame, image=img4, fg='Black', bg='Red', command=lambda: pressButton(globalList[3]), height=40, width=40)
button4.grid(row=2, column=0, padx=5, pady=5)

button5 = Button(buttonsFrame, image=img5, fg='Black', bg='Yellow', command=lambda: pressButton(globalList[4]), height=40, width=40)
button5.grid(row=2, column=1, padx=5, pady=5)

button6 = Button(buttonsFrame, image=img6, fg='Black', bg='Blue', command=lambda: pressButton(globalList[5]), height=40, width=40)
button6.grid(row=2, column=2, padx=5, pady=5)

button7 = Button(buttonsFrame, image=img7, fg='Black', bg='Orange', command=lambda: pressButton(globalList[6]), height=40, width=40)
button7.grid(row=3, column=0, padx=5, pady=5)

button8 = Button(buttonsFrame, image=img8, fg='Black', bg='Cyan', command=lambda: pressButton(globalList[7]), height=40, width=40)
button8.grid(row=3, column=1, padx=5, pady=5)

button9 = Button(buttonsFrame, image=img9, fg='Black', bg='Light Blue', command=lambda: pressButton(globalList[8]), height=40, width=40)
button9.grid(row=3, column=2, padx=5, pady=5)

button0 = Button(buttonsFrame, image=img10, fg='Black', bg='Hot Pink', command=lambda: pressButton(globalList[9]), height=40, width=40)
button0.grid(row=4, column=1, padx=5, pady=5)

backspace = Button(buttonsFrame, text='BACKSPACE', fg='Black', bg='Yellow', command=lambda: clearOne(), height=2, width=10)
backspace.grid(row=1, column=4, padx=5, pady=5)

clear = Button(buttonsFrame, text='CLEAR', fg='Black', bg='Red', command=lambda: clearAll(), height=2, width=10)
clear.grid(row=2, column=4, padx=5, pady=5)

enter = Button(buttonsFrame, text='ENTER', fg='Black', bg='Green', command=lambda: pressEnter(), height=2, width=10)
